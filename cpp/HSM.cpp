...
/////////////////////////////////////////////////////////////////////////////
// provide matrix of cluster indexes, parameters over the cols, simulations over the rows
// [[Rcpp::export]]
...
//-----------------------------------------------------------------------
// Various functions for sampling cluster indicators
// [[Rcpp::export]]
...
// [[Rcpp::export]]
arma::colvec update_zeta_cpp_marginalized_MEAN(arma::colvec Y,   // sampler with beta marginalized out
                             arma::colvec lambda2,
                             arma::colvec pi,
